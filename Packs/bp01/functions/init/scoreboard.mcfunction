...
scoreboard objectives add npc1_001 dummy
scoreboard objectives add 001_potions dummy
scoreboard objectives add 001_herbology dummy
scoreboard objectives add 001_spells dummy
scoreboard objectives add 001_alchemy dummy
scoreboard objectives add 001_astronomy dummy
...
scoreboard objectives add 5complete_init dummy
scoreboard players set @a 5complete_init 0
scoreboard objectives add end_stage dummy
scoreboard players set @a end_stage 0
...
scoreboard players set @a question 0

scoreboard objectives add pillar0 dummy
scoreboard objectives add pillar1 dummy
scoreboard objectives add pillar2 dummy
scoreboard objectives add pillar3 dummy

scoreboard players set @a pillar0 0
