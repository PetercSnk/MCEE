...
execute if score @p spell0 matches 1 if score @p spell1 matches 1 if score @p spell2 matches 1 run scoreboard players @p spells_comp 1
execute if score @p spells_comp matches 1 run function story/spells/notify
execute if score @p spells_comp matches 1 if score tmp @p matches 1 run function story/spells/complete
