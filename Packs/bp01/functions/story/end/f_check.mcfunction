...
execute if block -215 -58 265 emerald_block if block -215 -58 206 emerald_block if block -369 -58 265 emerald_block if block -369 -58 206 emerald_block run scoreboard players set @p end_stage 4