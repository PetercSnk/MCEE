...
execute if block -264 -38 228 wool 15 if block -265 -38 228 wool 0 if block -266 -38 228 wool 15 if block -267 -38 228 wool 0 if block -268 -38 228 wool 0 if block -269 -38 228 wool 0 if score @p alch3 matches 0 run give @p log 1 1
...
execute if block -250 -38 240 iron_block if block -254 -38 240 glowstone if block -250 -38 236 cobblestone if block -254 -38 236 log 1 run function story/alchemy/transmutation
